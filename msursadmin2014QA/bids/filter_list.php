	...
	if(isset($_GET["cat"]))
		{
			...
			if($cat=='products' or $cat=='search')
			{
			include "includes/products/filter_vars.php";
			...
			if(isset($_GET["auction"]))
			{
				...
				if($auction==1)
				{
					echo "<li class='active_filter'><a href='".$actual_link_auction."'>აუქციონზე</a></li>\n";
				}
				else
				{
					echo "<li><a href='".$actual_link_auction."&amp;auction=1'>აუქციონზე</a></li>\n";
				}
				if($auction==2)
				{
			...
			{
				echo "<li><a href='".$actual_link."&amp;auction=1'>აუქციონზე</a></li>\n";
			...
			if(isset($_GET["sort"]))
			{
				...
				{
					echo "<li><a href='".$actual_link_sort."&amp;sort=1'>ფასის ზრდადობის მიხედვით</a></li>\n";
				}
				if($sort==2)
				{
				...
				{
					echo "<li><a href='".$actual_link_sort."&amp;sort=2'> ფასის კლებადობის მიხედვით</a></li>\n";
				}
				if($sort==3)
				{
				...
				{
					echo "<li><a href='".$actual_link_sort."&amp;sort=3'>რეიტინგის ზრდადობის მიხედვით</a></li>\n";
				}
				if($sort==4)
				{
					//echo $actual_link;
				...
				{
					echo "<li><a href='".$actual_link_sort."&amp;sort=4'>რეიტინგის კლებადობის მიხედვით</a></li>\n";
				}
			...
			else
			{
				...
				echo "<li><a href='".$actual_link."&amp;sort=1'>ფასის ზრდადობის მიხედვით</a></li>\n";
				echo "<li><a href='".$actual_link."&amp;sort=2'> ფასის კლებადობის მიხედვით</a></li>\n";
				echo "<li><a href='".$actual_link."&amp;sort=3'>რეიტინგის ზრდადობის მიხედვით</a></li>\n";
				echo "<li><a href='".$actual_link."&amp;sort=4'>რეიტინგის კლებადობის მიხედვით</a></li>\n";
			}
			echo "</ul>\n";
			echo  "</div>\n";
