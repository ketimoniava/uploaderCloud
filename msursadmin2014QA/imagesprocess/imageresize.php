<?php
function resizeAndSave($dirSmall, $dirOriginal, $imgWidth, $fileSubmited, $imgFormIndex, $title, $fileExt){
		/*
		...
		*/
		...
		//echo $fileSubmited[0];
		//the image -> variables
		echo $file_type = $fileSubmited["type"][$imgFormIndex];
		$file_name = $fileSubmited["name"][$imgFormIndex];
        $file_size = $fileSubmited["size"][$imgFormIndex];
        echo $file_tmp = $fileSubmited["tmp_name"][$imgFormIndex];
